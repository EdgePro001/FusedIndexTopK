...
def framework_source_manifest(package_root: str | Path | None = None) -> dict[str, str]:
    ...
    Operators live below ``variants/`` or ``kernel/`` and carry their own
    source fingerprint. Keeping this traversal non-recursive prevents one
    operator implementation from changing the framework or baseline identity.
    """
