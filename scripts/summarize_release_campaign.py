#!/usr/bin/env python3
"""Audit and summarize the frozen-stack FusedIndexTopK qualification campaign."""
...
VARIANTS = ("flashinfer", "fused_index_topk", "torch")
BLOCKS = (
    ("block0_bct", ("flashinfer", "fused_index_topk", "torch")),
    ("block1_ctb", ("fused_index_topk", "torch", "flashinfer")),
    ("block2_tbc", ("torch", "flashinfer", "fused_index_topk")),
)
PROTOCOL = {
...
def _write_markdown(path: Path, payload: dict[str, Any]) -> None:
    ...
    lines = [
        "# FusedIndexTopK frozen-stack release qualification",
        "",
        ...
        "",
        "| layer | split | N | FlashInfer ms | FusedIndexTopK ms | reduction | 95% CI |",
        "|---:|---|---:|---:|---:|---:|---:|",
    ]
...
def main() -> None:
    ...
    gates = {
        ...
        "current_upstream_reason": (
            "FusedIndexTopK is qualified against pinned DeepGEMM 7c95b14; porting and "
            "rerunning current-main attention tests remains a separate gate"
        ),
    }
    payload = {
        "schema_version": 1,
        "title": "FusedIndexTopK frozen-stack release qualification",
        "method": (
