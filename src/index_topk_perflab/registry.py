...
ENTRY_POINT_GROUP = "index_topk_perflab.variants"
BUILTIN_VARIANTS = {
    "deepgemm_torch_unfused": "index_topk_perflab.variants.deepgemm_torch:create_variant",
    "deepgemm_flashinfer_topk_auto": (
