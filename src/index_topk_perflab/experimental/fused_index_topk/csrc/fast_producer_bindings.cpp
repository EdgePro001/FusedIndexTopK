...
#include "fast_producer_host.hpp"

#ifndef TORCH_EXTENSION_NAME
#define TORCH_EXTENSION_NAME fused_index_topk_producer_host
#endif

PYBIND11_MODULE(TORCH_EXTENSION_NAME, module) {
    module.doc() = "Host/JIT wrapper for the FusedIndexTopK candidate producer";
    module.def(
        "init_jit",
